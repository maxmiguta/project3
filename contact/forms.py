...
class ContactForm(forms.Form):
    ...
    phone_number = PhoneNumberField(error_messages={'invalid': 'Phone number must be 10 or 11 digits.'}, widget=forms.TextInput({'placeholder': 'Enter a valid national number'}), required=False)
